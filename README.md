...
#### 🎂 Birthday (생일 관리 시스템) - `cogs/birthday/`
*   `birthday_core.py`: **생일 기록 및 정기 알람 관리자.**
    *   유저의 생일을 데이터베이스에 기록하고 관리합니다.
    *   매일 오전 9시 정각에 요약 채널을 통해 `@everyone` 멘션과 함께 지정된 유저의 생일을 축하해주는 스케줄링 기능을 수행합니다.
