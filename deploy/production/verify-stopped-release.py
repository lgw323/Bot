...
OLD = Path('/opt/discordbot/releases/r-d14eba80bdec9126-3dac82a792fad576')
CONFIG = Path('/etc/discordbot/config.json')
DB_SHA = '1d871bed4ba8b8fe4fd9426cfa15c8b373f700baca2f548f5cea571570252363'
PRESERVED = {
    ...
    'phase10-retry-d14eba80bdec9126-live-smoke-guard-preservation': DB_SHA,
}
